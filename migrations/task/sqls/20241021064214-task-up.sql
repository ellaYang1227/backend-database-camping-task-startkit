...
and 
  "CREDIT_PURCHASE".created_at <= '2024-11-30 23:59:59'
group by "CREDIT_PACKAGE"."name" ;

-- 6-4. 查詢：計算 11 月份總營收（使用 price_paid 欄位統計）
-- 顯示須包含以下欄位： 總營收
...
-- 顯示須包含以下欄位： 預約會員人數
-- 說明：Distinct 關鍵字，用來確保每個會員只被計算一次
...
and 
	"COURSE_BOOKING".created_at <= '2024-11-30 23:59:59' 
and 
